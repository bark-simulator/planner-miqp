...
struct RawResults {
  ...
  Eigen::Tensor<int, 4>
      car2car_collision;  //(NumCar2CarCollisions, NumCar2CarCollisions, N, 16);
                          // 16 Idxs: Rear/rear = 1..4, Rear/front = 5..8,
                          // Front/rear = 9..12, Front/front = 13..16
  Eigen::Tensor<int, 4>
      slackvars;  //(NumCar2CarCollisions, NumCar2CarCollisions, N, 4);
                  // 4 Idxs: rear x = 1, rear y = 2, front x = 3, front y = 4
  Eigen::Tensor<int, 3> slackvarsObstacle;        //(NrCars, NrObstacles,  N)
  Eigen::Tensor<int, 4> slackvarsObstacle_front;  //(NrCars, NrObstacles,  N, 4)
...
struct ModelParameters {
  ...
  // Solver Parameters
  float max_solution_time;  // default: 1e+75, limit maximum time, if cplex
                            // already found a valid integer solution, it return
                            // with success but not the global optimum
  float relative_mip_gap_tolerance;  // default: 1e-04, opimality gap
  int mipdisplay;                    // default: 2, display verbosity
                   // https://www.ibm.com/support/knowledgecenter/SSSA5P_12.9.0/ilog.odms.cplex.help/CPLEX/Parameters/topics/MIPDisplay.html
  int mipemphasis;  // default: 0, find feasible solutions fast
                    // https://www.ibm.com/support/knowledgecenter/SSSA5P_12.9.0/ilog.odms.cplex.help/CPLEX/Parameters/topics/MIPEmphasis.html
  float
      relobjdif;  // default 0.0, ignore integer solutions that are not x%
                  // better than already found ones
                  // https://www.ibm.com/support/knowledgecenter/en/SSSA5P_12.10.0/ilog.odms.cplex.help/CPLEX/Parameters/topics/RelObjDif.html
  int cutpass;  // default: 0, proposed by the tuning tool, nr of cutting planes
                // //https://www.ibm.com/support/knowledgecenter/SSSA5P_12.9.0/ilog.odms.cplex.help/CPLEX/Parameters/topics/CutPass.html
  int probe;    // default: 0, probing:  logical implications of fixing each
                // binary variable to 0 or
  // 1https://www.ibm.com/support/knowledgecenter/SSSA5P_12.9.0/ilog.odms.cplex.help/CPLEX/Parameters/topics/Probe.html
  int repairtries;  // default: 0, number of tries to repair a warmstart
                    // solution
                    // //https://www.ibm.com/support/knowledgecenter/pl/SSSA5P_12.9.0/ilog.odms.cplex.help/CPLEX/Parameters/topics/RepairTries.html
  int rinsheur;     // default: 0, relaxation induced neighborhood search (RINS)
                    // heuristic
  // //https://www.ibm.com/support/knowledgecenter/en/SS9UKU_12.9.0/com.ibm.cplex.zos.help/CPLEX/Parameters/topics/RINSHeur.html
  int varsel;  // default: 0, select branching variable: cplex automatically
               // takes 4 (best in our case) //
               // https://www.ibm.com/support/knowledgecenter/SSSA5P_12.9.0/ilog.odms.cplex.help/CPLEX/Parameters/topics/VarSel.html
  int mircuts;       // default: 0,  mixed integer rounding cuts
  int parallelmode;  // default: 0, opportunistic (-1) or deterministic (1)
                     // parallel search
